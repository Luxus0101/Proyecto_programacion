...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game)
{
  ...
  if ((id_act = game_get_player_location(game)) != NO_ID)
  {
    ...
    if (link_setId != NO_ID)
    {
      sprintf(str, "  +-----------+ %2d", (int)link_getConnection1);
      screen_area_puts(ge->map, str);
      sprintf(str, "  | 8D      %2d| ==> %2d", (int)id_act, (int)link_setId(id1));
      screen_area_puts(ge->map, str);
      ...
      if (link_setId != NO_ID)
      {
        sprintf(str, " %2d +-----------+ ", (int)link_getConnection2);
        screen_area_puts(ge->map, str);
        sprintf(str, "%2d <== | 8D      %2d|", (int)link_setId(id1), (int)id_act);
        screen_area_puts(ge->map, str);
  ...
  sprintf(str, "  Last roll: %d", dice_last_roll(game_get_dice(game)));
  screen_area_puts(ge->descript, str);
  char obj_name[100] = "";
  int num;
  for (int i = 0; i < MAX_OBJECTS; i++)
  ...
  sprintf(str, "      next or n, back or b, exit or e, d or drop, t or take, rl or roll,             l or left, r or right");
  screen_area_puts(ge->help, str);
